...
public class InstanceOf {
    public static void main(String[] args) {
        ...
        if (a instanceof Object) System.out.println("а можн привести к типу Object");
        if (b instanceof Object) System.out.println("b можн привести к типу Object");
        if (c instanceof Object) System.out.println("c можн привести к типу Object");
        if (d instanceof Object) System.out.println("d можн привести к типу Object");
    }
}
